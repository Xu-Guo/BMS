...
<div region="west" style="width: 200px" title="Menu" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		<div title="Common Operations" data-options="selected:true,iconCls:'icon-item'" style="padding: 10px">
			<a href="javascript:openTab('View battery status','listBattery.jsp','icon-review')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-review'" style="width: 150px">View Battery Status</a>
		...
		<div title="Manage Errors"  data-options="iconCls:'icon-plgl'" style="padding:10px">
			<a href="javascript:openTab('View Errors','ErrorReview.jsp','icon-review')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-review'" style="width: 150px">Review Errors</a>
		...
		<div title="Manage Alarms"  data-options="iconCls:'icon-plgl'" style="padding:10px">
			<a href="javascript:openTab('View Alarms','AlarmReview.jsp','icon-review')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-review'" style="width: 150px">Review Alarms</a>
		...
		<div title="Manage Error Type" data-options="iconCls:'icon-bklb'" style="padding:10px">
			<a href="javascript:openTab('Manage Error Type','ErrorTypeManage.jsp','icon-bklb')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-bklb'" style="width: 150px;">Manage Error Type</a>
		</div>
		
		<div title="Manage Alarm Type" data-options="iconCls:'icon-bklb'" style="padding:10px">
			<a href="javascript:openTab('Manage Alarm Type','AlarmTypeManage.jsp','icon-bklb')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-bklb'" style="width: 150px;">Manage Alarm Type</a>
		</div>
