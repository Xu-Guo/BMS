...
<script type="text/javascript">
	...
	function alarmReview(handledMark){
		var selectedRows=$("#dg").datagrid("getSelections");
		if(selectedRows.length==0){
			$.messager.alert("System","Please select a alarm to review!");
			return;
		}
		var strIds=[];
		...
		var ids=strIds.join(",");
		$.messager.confirm("System","Please confirm to operate on the selected <font color=red>"+selectedRows.length+"</font> alarm.",function(r){
			if(r){
				$.post("${pageContext.request.contextPath}/public/alarm/review.do",{ids:ids,handledMark:handledMark},function(result){
					if(result.success){
...
<table id="dg" title="Review Alarms" class="easyui-datagrid" 
  fitColumns="true" pagination="true" rownumbers="true"
  url="${pageContext.request.contextPath}/public/alarm/list.do?handledMark=0" fit="true" toolbar="#tb">
  <thead>
  	<tr>
...
<div id="tb">
	<div>
		<a href="javascript:alarmReview(1)" class="easyui-linkbutton" iconCls="icon-ok" plain="true">Mark handled</a>
	</div>
</div>
